...
public class OrderAdapter extends ArrayAdapter<Order> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.itemname.setText(orderList.get(position).getFname());
        //   holder.itemid.setText(customerList.get(position).getid());
        holder.itemphone.setText(orderList.get(position).getPhone());
...
//        String newTime2  = newTime.replace("2016","");
        holder.itemTime.setText(orderList.get(position).getCity());
